<template>
  <div class="auth-wrapper auth-v2">
    <b-row class="auth-inner m-0">
      ...
      <!-- Left Text-->
      <b-col lg="10" class="d-none d-lg-flex align-items-center p-5 m-auto">
        <div
        ...
        >
          <div class="card text-left">
            ...
            <div class="card-body">
              <h1 class="card-title text-primary text-center">Conditions générales d'utilisation (CGU) </h1>
              <p class="card-text">
...
export default {
  ...
  mounted() {
    document.title = "Siloë-connect school-CGU";
  },
};
</script>
